...
if(isset($_POST['update_profile'])){
    ...
    if($valid_full_name == 1 && $valid_email == 1 && $valid_password == 1 && $valid_confirm_password == 1 && $valid_border_number == 1 && $valid_village_or_road_name == 1 && $valid_post_office_name == 1 && $valid_sub_district_name == 1 && $valid_district_name == 1){
        ...
        if ($connection === false){
            ...
            //check the user
            $update = "UPDATE `tbl_student_registration`
            SET 
            `student_full_name`='$student_full_name',
            `student_email`='$student_email',
            `student_password`='$student_password',
            `village_or_road_name`='$student_village_or_road_name',
            `post_office_name`='$student_post_office',
            `sub_district_name`='$student_sub_district_name',
            `district_name`='$student_district_name' WHERE `student_border_number` = '$border_number'";
            ...
            if($result_update){
                echo "<h2 style='color: white'>Profile Updated</h2>";
            }
            else{
